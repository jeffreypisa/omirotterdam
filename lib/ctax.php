...
// hook into the init action and call create_verhalenatlas_tax when it fires
add_action( 'init', 'create_verhalenatlas_tax', 0 );
function create_verhalenatlas_tax() {
	...
	$args = array(
		...
		'show_admin_column' => true,
		'query_var'         => true,
		'rewrite'           => array('slug' => 'verhalenatlas')
	);
